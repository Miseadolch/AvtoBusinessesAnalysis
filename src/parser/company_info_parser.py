...
class CompanyInfoData:
    organization_name: list = field(default_factory=list)
    general_director: list = field(default_factory=list)
    type_of_company: list = field(default_factory=list)
    registration_date_datetime: list = field(default_factory=list)
    registration_date_timestamp: list = field(default_factory=list)
    founders: list = field(default_factory=list)
    inn: list = field(default_factory=list)
    ogrn: list = field(default_factory=list)
    kpp: list = field(default_factory=list)
    okpo: list = field(default_factory=list)
    okato: list = field(default_factory=list)
    oktmo: list = field(default_factory=list)
    okogu: list = field(default_factory=list)
    postal_code: list = field(default_factory=list)
